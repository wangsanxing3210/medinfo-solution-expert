...
2. **你会得到什么**：一份符合国内标准的「文档摘要 + 11 个正文章节」（共 12 个一级标题）结构化 Markdown 方案；审核/优化会输出问题清单与修改建议；编撰完自动附带一份预评分自检报告。
...
- 询问 / 推断用户的项目场景归属（详见 `references/scenarios.md` 的 19 大场景，含智慧医院 / 互联互通 / 医共体 / EMR 评级 / 中心药房 / 云审方 / 智慧中药房 / SPD / 城市医疗集团 / 全民健康信息平台 / 公共卫生妇幼 / 互联网医院 / 医疗大数据 / 政务云 / 基层云化 / 智能终端物联网 / 连锁民营 / 基层 / 单项系统 / AI 专项 / 综合）
...
- 技能：场景=县域医共体数智一体 → 检索标准 → 按模板输出 12 个一级标题方案 → 自动跑自检（预评分 82/良好）→ 输出自检报告，标注 2 个中优先级待补项（密评规划、数据治理专项）
