...
version: 1.0.0
description: 医疗信息化解决方案编撰、审核、优化专家级技能。当用户需要基于医院场景需求（智慧医院建设、互联互通成熟度测评、紧密型医共体数智一体建设、紧密型城市医疗集团数智化、电子病历分级评价、中心药房、云审方中心、连锁民营医院数智化、三级以下单体医疗机构数智化、HIS/EMR/LIS/PACS/HRP/集成平台升级等）撰写标准化解决方案文档，或对已有方案进行政策符合性、逻辑完整性、技术可行性、数据流闭环、安全合规、AI 赋能合理性审核，或从架构、流程、数据流、技术选型维度优化润色方案时使用本技能。内置医疗信息化标准规范库（HL7 FHIR / IHE / 等保 / WS/T 系列）、核心系统知识库、10 大项目场景库、AI 医疗应用场景库、中心药房与云审方专项库、方案审核清单，输出符合国内医疗信息化标准的结构化 Markdown 方案文档。触发词：医疗信息化方案、医院信息化解决方案、智慧医院方案、互联互通测评方案、医共体建设方案、城市医疗集团方案、电子病历升级方案、EMR评级方案、CDSS方案、医学影像AI方案、中心药房方案、处方流转方案、云审方方案、前置审方方案、连锁医院信息化方案、基层医疗机构信息化方案、医疗信息化方案审核、方案优化、方案润色。
agent_created: true
---
